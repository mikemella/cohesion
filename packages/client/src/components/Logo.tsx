...
export function LogoMark({ size = 40, className = '', animate = false }: LogoMarkProps) {
  ...
  return (
    ...
    >
      ...
      <rect x={9}  y={9}  width={22} height={22} rx={3} fill="#B4F042" {...sq(0)}/>
      <rect x={34} y={9}  width={22} height={22} rx={3} fill="#B4F042" {...sq(1)}/>
      <rect x={59} y={9}  width={22} height={22} rx={3} fill="#B4F042" {...sq(2)}/>
      <rect x={84} y={9}  width={22} height={22} rx={3} fill="#B4F042" {...sq(3)}/>

      {/* Row 1: green spine, purple interior */}
      <rect x={9}  y={34} width={22} height={22} rx={3} fill="#B4F042" {...sq(4)}/>
      ...
      <rect x={9}  y={59} width={22} height={22} rx={3} fill="#B4F042" {...sq(8)}/>
      ...
      <rect x={9}  y={84} width={22} height={22} rx={3} fill="#B4F042" {...sq(12)}/>
      <rect x={34} y={84} width={22} height={22} rx={3} fill="#B4F042" {...sq(13)}/>
      <rect x={59} y={84} width={22} height={22} rx={3} fill="#B4F042" {...sq(14)}/>
      <rect x={84} y={84} width={22} height={22} rx={3} fill="#B4F042" {...sq(15)}/>
    </svg>
  );
}
